...
#                     forever.
print("forward")
robot.forward(50, 1.0)   # Move forward at speed 150 for 1 second.
print("left")
robot.left(50, 1)      # Spin left at speed 200 for 0.5 seconds.
robot.forward(50, 1.0)   # Repeat the same movement 3 times below...
print("left")
robot.left(50, 1)
print("forward")
